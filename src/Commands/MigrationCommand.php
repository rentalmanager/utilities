...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'rm:migrate-utilities';
     ...
     * @var string
     */
    protected $description = 'Creates a migration for the utilities package.';
     ...
     * @var string
     */
    protected $migrationSuffix = 'rental_manager_utilities_setup_tables';
    ...
    protected function createMigration()
    {
        ...
        $output = $this->laravel->view
            ->make('utilities::migration')
            ->with(['utilities' => Config::get('utilities')])
            ->render();
    ...
    {
        $tables = Collection::make(Config::get('utilities.tables'))->sort();
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Utilities migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Utilities migration already exists.\nFollowing file was found: ";
        }
